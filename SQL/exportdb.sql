...
/*!50003 TRIGGER `library`.`IssuedBook_AFTER_INSERT` AFTER INSERT ON `IssuedBook` FOR EACH ROW
 BEGIN
 UPDATE Book_Count 
 SET BookNo = BookNo+1
...
/*!50003 CREATE*/
/*!50017 DEFINER=`root`@`localhost`*/
/*!50003 TRIGGER count AFTER DELETE on IssuedBook
 FOR EACH ROW
 BEGIN
 UPDATE Book_Count 
 SET BookNo = BookNo-1
...
/*!50003 CREATE*/
/*!50017 DEFINER=`root`@`localhost`*/
/*!50003 TRIGGER `library`.`IssuedMagazine_AFTER_INSERT` AFTER INSERT ON `IssuedMagazine` FOR EACH ROW
 BEGIN
 UPDATE Book_Count
 SET BookNo = BookNo +1 
...
/*!50003 CREATE*/
/*!50017 DEFINER=`root`@`localhost`*/
/*!50003 TRIGGER `library`.`IssuedMagazine_AFTER_DELETE` AFTER DELETE ON `IssuedMagazine` FOR EACH ROW
 BEGIN
 UPDATE Book_Count
 SET BookNo = BookNo
 where Book_Count.UserID = OLD.UserID;
...
INSERT INTO
  `Users`
VALUES
  (10, '1234', '2012-05-15', 'sudarshan', 'sudarshan@gmail.com');
...
/*!50003 CREATE*/
/*!50017 DEFINER=`root`@`localhost`*/
/*!50003 TRIGGER `library`.`Users_AFTER_INSERT` AFTER INSERT ON `Users` FOR EACH ROW
 BEGIN
